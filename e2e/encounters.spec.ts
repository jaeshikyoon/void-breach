...
const REQUIRED_RUNTIME_ASSETS = [
  '/assets/game/arena.png',
  '/assets/game/arena-plague.jpg',
  '/assets/game/arena-cryo.jpg',
  '/assets/game/arena-void.jpg',
  '/assets/game/arena-rift.jpg',
  '/assets/game/player-sheet.png',
  '/assets/game/enemies-sheet.png',
  '/assets/game/enemies-expansion.png',
  '/assets/game/bosses-sheet.png',
  '/assets/game/props/bullet.png',
  '/assets/game/props/xp-crystal.png',
  '/assets/game/vfx-atlas.png',
  '/assets/game/skill-vfx-atlas-v2-clean.png',
  '/assets/game/props/missile.png',
  '/assets/game/props/enemy-projectile.png',
  '/assets/game/props/elite-crystal.png',
  '/assets/game/props/landmine.png',
  '/assets/game/props/turret.png',
  '/assets/game/props/drone.png',
] as const;
